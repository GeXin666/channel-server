...
@RestController
@RequestMapping("/JcShebController")
public class JcShebController {

    @Autowired
    private JcShebService service;
    ...
    public JsonResult selectPageModel(PageBounds pb, @RequestParam Map<String,Object> params) {
        PageModel<JcSheb> model = service.selectPageModel(pb, params);
    ...
    public JsonResult selectByPrimaryKey(String id) {
        JcSheb instance = service.selectByPrimaryKey(id);
    ...
    public JsonResult insertOrUpdate(JcSheb record) {
