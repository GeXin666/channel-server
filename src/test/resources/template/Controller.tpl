...
import ${servicePackage}.${sn}Service;
...
@RestController
@RequestMapping("/${sn}Controller")
public class ${sn}Controller {

    @Autowired
    private ${sn}Service service;
    ...
    public JsonResult selectPageModel(PageBounds pb, @RequestParam Map<String,Object> params) {
        PageModel<${sn}> model = service.selectPageModel(pb, params);
    ...
    public JsonResult selectByPrimaryKey(String id) {
        ${sn} instance = service.selectByPrimaryKey(id);
    ...
    public JsonResult insertOrUpdate(${sn} record) {
